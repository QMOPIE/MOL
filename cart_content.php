<?php
                        ...
                        <!-- <button type="button" id="btn04" name="btn04" class="btn btn-warning">前往結帳</button> -->
                                    ...
                                    <tr>
                                        ...
                                        <td style="min-width:100px;">
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="qty[]" name="qty[]" min="1" max="49" value="<?php echo $cart_data['qty']; ?>"  cartid="<?php echo $cart_data['cartid']; ?>" required style="min-width:60px;">
                                            </div>
                                        </td>
                                        <td>$<?php echo $cart_data['p_price'] * $cart_data['qty']; ?>
                                        </td>
